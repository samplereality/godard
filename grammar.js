const rules = {
  ...
  arrives:
    "arrives | is already there reading the sayings of Mao | lies dead on the superhighway with brains spattered | is killing himself | harangues a crowd | runs along the street | jumps out of a window",

  bang: "bang | splash | splat | wham | rat-tat-tat | mumble mumble",

  refinery:
    "a refinery | a kindergarten | Notre Dame | the Communist Party headquarters | the House of Parliament | the Parthenon | the office of <em>Le Figaro</em> | the Elysée | Paris",

  Americans:
    "The Americans | The Germans | French paratroopers | The Vietnamese | Arabs | Israelis | The police",

  love: "make love | do not make love.",

  Cannibals:
    "Cannibals | Indians | Hordes of accountants | Dissident Commmunists | Crazed truck drivers",

  bazookas:
    "bazookas | yagatans | copies of <em>Le Figaro</em> | pirate's sabers | submachine guns | cans of $color paint | Picasso paintings | little red books | picture postcards",
  ...
  railroad:
    "on the railroad. | on the Elysée. | on the University of Nanterre. | in Piazza Navona. | all over the road.",

  falls:
    "falls, $bullets | is thrown out of the window by CIA agents | is captured by paratroopers. | is killed by Australian aborigines.",

  bullets:
    "riddled with bullets from a $rifle. | with a gaping wound in the belly. | spewing forth streams of $color paint. | making love with Voltaire.",

  rifle: "rifle | Loquat",

  Speed:
    "At mad speed | Unsteadily | Very, very slowly | Remaining still while the background &lpar;a process shot&rpar; moves",

  Vincennes:
    "Vincennes, | Nanterre, | Flins, | Place de la Bastille, | Clignancourt, | Venice,",

  cohn: "Cohn-Bendit | Jacques Servan-Schreiber | Jean-Paul Sartre | Pier Paolo Pasolini | D'Alembert",

  train:
    "catches the train | misses the train | goes on a bicycle | roller skates",
  ...
  Diderot:
    "Diderot. | Daniel Cohn-Bendit. | Nixon. | Madame de Sevigné. | Voiture. | Van Vogt. | Einstein.",
